                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($product->deleted_at==null)
                                                        ...
                                                        <a
                                                            href="{{ route('product.destroy',['id'=>$product->product_id]) }}"><button
                                                                class="btn btn-danger btn-sm">Disable</button></a>
                                                    @else
                                                        <a
                                                            href="{{ route('product.enable',['id'=>$product->product_id]) }}"><button
                                                                class="btn btn-success btn-sm">Enable</button></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
