        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
              <li class="breadcrumb-item "><a href="{{route('gst_sell')}}">Gst Sales</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-muted">
              <div class="card-header">
                <h3 class="card-title text-secondary">Add Gst Payment </h3>
              ...
              <!-- /.card-header -->
              <!-- form start -->
            <form role="form" id="quickForm" method="post" action="{{route('gstpayment.store')}}" >
                @csrf
                <div class="card-body">
                    <div class="row">
                        {{-- Sell To Name --}}
