      ...
      <table id="example1" class="table table-bordered table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>{{\Carbon\Carbon::parse($bill_detail->bill_date)->format('d-m-Y')}}</td>
              <td>{{$bill_detail->amount}}</td>
              <td><a href="{{route('invoice.view',['bill_id'=>$bill_detail->bill_id])}}"><button class="btn btn-small btn-info">View</button></a></td>
          </tr>
         @endforeach
        </tbody>
        <tfoot>
