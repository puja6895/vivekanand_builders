        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-muted">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" method="POST" action="{{route('unit.store')}}" >
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="unit_name" required class="form-control  {{$errors->has('unit_name') ? 'is-invalid' : ''}}" id="customer_name" placeholder="Enter unit" value="{{ old('unit_name')}}">
                    {{-- Error handling --}}
